...
def f(A, queries):
    ...
    for val,index in queries:
        ...
        #значение которое мы меняем, обновляем - нужно убрать СНАЧАЛА ИЗ ОБЩЕЙ СУММЫ!!!!! елси не делать этого, то получица что мы его дальше в общей
        # сумме тащим и не обновляем. а только добавляем новые четные значения!
        A[index]+= val
